...
class LoginView extends StatelessWidget {
  ...
  // Widget hjadgs(context){
  //   return Scaffold(
  //     resizeToAvoidBottomInset: false,
  //     body: Stack(
  //       children: <Widget>[
  //         Image.asset(ImageAssets.splash,fit: BoxFit.cover,),
  //         Expanded(child: blurCard(context))
  //
  //       ],
  //     ),
  //   );
  ...
  // Widget blurCard(context){
  //   return
  // }

  // Widget cardofScreen(context){
  //   return  Column(
  //     mainAxisAlignment: MainAxisAlignment.end,
  //     crossAxisAlignment: CrossAxisAlignment.center,
  //     children: [
  //       Padding(
  //         padding: const EdgeInsets.only(bottom: 60.0,left: 30,right: 30),
  //         child: ClipRect(
  //           child:  BackdropFilter(
  //             filter:  ImageFilter.blur(sigmaX: 12.0, sigmaY: 8.0),
  //             child:  Container(
